...
DraftListSendState = require './draft-list-send-state'
...
module.exports =
  activate: (@state={}) ->
    ...
    ComponentRegistry.register DraftListSendState,
      role: 'DraftList:DraftState'
  ...
  deactivate: ->
    ...
    ComponentRegistry.unregister DraftListSendState
